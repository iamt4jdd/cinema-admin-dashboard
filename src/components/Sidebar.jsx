    ...
    return (
        <Router>
            <div className="bg-gray-200 w-64 h-screen shadow-lg">
                ...
                <nav className="mt-10">
                    <NavLink to="/users" className="text-center block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-500 hover:text-white mt-2 focus:bg-blue-500 focus:text-white mt-2">Users</NavLink>
